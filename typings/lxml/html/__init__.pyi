...
if TYPE_CHECKING:
    ...
    from ..etree import _AnySmartStr, _AnyStr, _BaseParser, _Element, ElementBase
...
class HtmlElement(HtmlMixin, ElementBase): ...
...
def tostring(
    ...
    encoding: Callable[[str], object]= ...,
    method: Literal["html", "xml", "text"]=...,
): ...
