...
import re
from typing import ClassVar, Final, Literal, Pattern
...
class _Attr(object):
    ...
    .. seealso:: :func:`convert_entities`
    """
    mask_o: ClassVar[int] = u | h | s

    set0: ClassVar[int] = 0
    "suppress all transformations. (Do nothing.)"
    set1: ClassVar[int] = q | b | d | e
    "equivalent to :attr:`q` | :attr:`b` | :attr:`d` | :attr:`e`"
    set2: ClassVar[int] = q | b | D | e
    """
    equivalent to :attr:`q` | :attr:`b` | :attr:`D` | :attr:`e`

    For old school en- and em- dash.
    """
    set3: ClassVar[int] = q | b | i | e
    """
    ...
    @default.setter
    def default(self, attr: int) -> None:
...
.. seealso:: :class:`_Attr`
"""
default_smartypants_attr: int = Attr.set1


tags_to_skip: Final = ['pre', 'samp', 'code', 'tt', 'kbd', 'script', 'style', 'math']
"""
...
def _tags_to_skip_regex(tags: str | list[str] | tuple[str, ...] | None = None) -> Pattern[str]:
    """
...
def smartypants(text: str, attr: int | None = None) -> str:
    """
...
def convert_single_backticks(text: str) -> str:
    """
...
def convert_dashes(text: str) -> str:
    """
    Convert `` - `` in *text* into en-dash HTML entities.
...
def convert_dashes_oldschool(text: str) -> str:
    """
...
def convert_dashes_oldschool_inverted(text: str) -> str:
    """
...
def convert_ellipses(text: str) -> str:
    """
...
def convert_entities(text: str, mode: Literal[0, 1, 2, 3]) -> str:
    """
